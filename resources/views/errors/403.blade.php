        ...
        <div class="z-20 px-10 py-10 flex flex-col items-center justify-center md:flex-row">
            <div class="lg:px-10">
                <div class="bg-[#FFDB4F] text-center rounded-lg shadow-lg p-6">
                    <p class="text-lg font-bold md:text-2xl lg:text-4xl">Hmmm.... Kamu Tersesat yaa</p>
                </div>
                <div class="my-5 flex flex-col items-center">
                    <p class="text-white text-sm lg:text-xl">Daripada jalan ga jelas mending balik lagi aja yuk</p>
                    <a href="/" class="mt-4">

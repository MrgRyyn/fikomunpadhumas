...
<head>
    ...
    <title>OTP - Masukkan Kode OTP</title>
...
<body class="maroon-bg flex h-screen items-center justify-center p-4">
    ...
    <div class="w-full max-w-sm rounded-xl bg-white p-8 shadow-2xl md:max-w-md md:p-12">
        ...
        <form id="otp-form">
            ...
            <div id="otp-inputs" class="mb-6 flex justify-center space-x-2 sm:space-x-3">
                ...
                <input type="text" maxlength="1" id="otp-2" class="otp-input text-gray-900" inputmode="numeric">
            ...
            <div id="error-state" class="text-center mb-4 hidden">
    ...
    <!-- Success Modal (Reusing structure from voting page) -->
    <div id="success-modal" class="modal-backdrop fixed inset-0 z-50 hidden items-center justify-center p-4">
        <div class="w-full max-w-sm transform overflow-hidden rounded-xl bg-white p-6 text-center align-middle shadow-xl">
            ...
            <h3 class="mb-2 text-2xl font-bold text-gray-800">Verifikasi Berhasil!</h3>
            <p class="mb-6 text-gray-600">Anda berhasil masuk. Melanjutkan ke halaman vote...</p>
    ...
    <script>
        ...
        function resetFormState() {
            // Revert state from error display to normal
            errorState.classList.add('hidden');
            instructionText.classList.remove('hidden');
            otpInputs.forEach(input => input.classList.remove('border-red-600'));
        ...
        function closeSuccessModal() {
            ...
            // In a real application, you would redirect to the voting page here
            document.body.innerHTML = `
                <div class="maroon-bg flex h-screen flex-col items-center justify-center text-center text-white">
                    <h2 class="text-3xl font-bold mb-4">Redirecting...</h2>
                    <p class="text-xl">Anda telah berhasil masuk!</p>
                    <p class="mt-8 text-sm text-red-300">
                        (Simulasi: Anda akan diarahkan ke halaman Voting.)
                    </p>
                </div>
            `;
        }
